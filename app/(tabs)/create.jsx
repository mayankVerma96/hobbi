...
const CreatePost = () => {
  ...
  const submit = async () => {
    if (!form.title || !form.video || !form.thumbnail || !form.caption) {
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker("video")}>
            {form.video ? (
              ...
              <View className="w-full h-40 px-4 bg-black-100 border-2 border-black-200 rounded-2xl justify-center items-center">
